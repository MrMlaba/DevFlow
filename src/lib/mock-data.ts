...
export interface MockPullRequest {
  ...
  securityStatus: "passed" | "failed" | "warning";
...
export const MOCK_PULL_REQUESTS: MockPullRequest[] = [
  {
    ...
    additions: 612,
    deletions: 34,
    reviewers: ["Sipho Dlamini"],
    ciStatus: "success",
    securityStatus: "passed",
    deploymentStatus: "deployed",
    linkedTask: "TASK-104 Implement authentication",
    createdAt: daysAgo(1),
    status: "merged",
  },
  {
    ...
    author: "Priya Naidu",
    sourceBranch: "feature/kanban-dnd",
    targetBranch: "main",
    filesChanged: 9,
    additions: 340,
    deletions: 21,
    reviewers: ["Liam Carter", "Sipho Dlamini"],
    ciStatus: "running",
    securityStatus: "passed",
    deploymentStatus: "not_deployed",
    linkedTask: "TASK-118 Implement project Kanban board",
    createdAt: daysAgo(0),
    status: "open",
  },
  {
    ...
    author: "Priya Naidu",
    sourceBranch: "fix/session-refresh",
    targetBranch: "main",
    filesChanged: 3,
    additions: 54,
    deletions: 12,
    ...
    linkedTask: "TASK-121 Fix session refresh race condition",
    createdAt: daysAgo(2),
    status: "open",
  },
];
